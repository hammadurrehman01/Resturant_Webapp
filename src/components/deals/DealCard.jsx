...
export default function DealCard({ deal, currency = 'PKR' }) {
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-stone-200 bg-gradient-to-br from-brand-50 via-white to-amber-50 shadow-sm transition hover:shadow-md">
      {/* Discount badge */}
      ...
      {deal.image ? (
        ...
        <div className="grid h-40 w-full place-items-center bg-gradient-to-br from-brand-100 to-amber-100">
